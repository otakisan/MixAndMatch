//
//  CombinationListFilteredTableViewController.swift
//  MixAndMatch
//
...
class CombinationListFilteredTableViewController: CombinationListBaseTableViewController {

    var navigationControllerOfOriginalViewController : UINavigationController?
    var delegate : CombinationListFilteredTableViewControllerDelegate?
    ...
    override func tableView(tableView: UITableView, commitEditingStyle editingStyle: UITableViewCellEditingStyle, forRowAtIndexPath indexPath: NSIndexPath) {
        if editingStyle == .Delete {
            ...
            self.showOkCancelAlertMessage("本当に削除しますか？", message: "完全に削除され、元に戻せません。",
                okHandler: { alertAction in self.delegate?.deleteActionViaFilteredList(self.combinations[indexPath.row]) },
...
protocol CombinationListFilteredTableViewControllerDelegate {
